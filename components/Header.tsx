    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0B0F14]/80 backdrop-blur-md supports-[backdrop-filter]:bg-[#0B0F14]/70">
      ...
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        ...
        >
          <a
            href="#cta"
            aria-label="Diagnosticar meu negócio"
            data-cta="cta"
            data-label="Header - Diagnosticar meu negócio"
          >
            Diagnosticar meu negócio
          </a>
        </Button>
